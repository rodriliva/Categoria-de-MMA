    ...
    if (document.getElementById('male').checked) {
        ...
        switch (true) {
            case finalPound == 0:
                ...
                break;
            case finalPound <= 115:
                document.getElementById("resultPound").innerHTML = `Você seria da categoria <b>Peso Palha</b>, pois você tem o que equivale a ${finalPound}lb`;
                break;
            case finalPound <= 125:
                document.getElementById("resultPound").innerHTML = `Você seria da categoria <b>Peso Mosca</b>, pois você tem o que equivale a ${finalPound}lb`;
                break;
            ...
            case finalPound <= 145:
                ...
                break;
            case finalPound > 145:
                document.getElementById("resultPound").innerHTML = `O limite das categorias femininas é 145lb e você possui ${finalPound}lb`;
                break;
            default: document.getElementById("resultPound").innerHTML = "Digite um peso correto";
        };
    }
